...
inference_d1 = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/inference_d1'),
...
inference_d7 = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/inference_d7'),
    new_cluster=generate_cluster(other=configs),
    dag=dag
)
...
inference_d30 = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/inference_d30'),
    new_cluster=generate_cluster(other=configs),
    dag=dag
)
...
actuals = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/actuals'),
    new_cluster=generate_cluster(other=configs),
    dag=dag
)
...
monitoring = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/monitoring'),
    new_cluster=generate_cluster(other=configs),
    dag=dag
)
...
sanity_check = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task(f'/predictive_analytics/{location}/imt_ad_d90/jobs/sanity_checks'),
    new_cluster=generate_cluster(other=configs),
    dag=dag
)
