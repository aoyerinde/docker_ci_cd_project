...
ab_tests_users = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/ab_test_users'),
...
config_table = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/config_table'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
ab_tests_overview = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/ab_tests_overview'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
ab_test = DatabricksSubmitRunOperator(
    ...
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/ab_test'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
health_check_aa_test_machine_learning = DatabricksSubmitRunOperator(
    ...
    databricks_retry_delay=60,
    databricks_retry_limit=3,
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/health_check_aa_test_machine_learning'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
health_check_multiple_abtest_concurrently = DatabricksSubmitRunOperator(
    ...
    databricks_retry_delay=60,
    databricks_retry_limit=3,
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/health_check_multiple_abtest_concurrently'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
health_check_sufficient_sample_size = DatabricksSubmitRunOperator(
    ...
    databricks_retry_delay=60,
    databricks_retry_limit=3,
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/health_check_sufficient_sample_size'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
health_check_multiple_groups_in_same_test = DatabricksSubmitRunOperator(
  ...
  databricks_retry_delay=60,
  databricks_retry_limit=3,
  notebook_task=generate_notebook_task('/production/jobs/ab-testing/health_check_multiple_groups_in_same_ab_test'),
  new_cluster=generate_cluster(),
  dag=dag
)
...
health_check_equal_user_allocation = DatabricksSubmitRunOperator(
    ...
    databricks_retry_delay=60,
    databricks_retry_limit=3,
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/health_check_equal_user_allocation_into_group'),
    new_cluster=generate_cluster(),
    dag=dag
)
...
bootstrapping_for_new_users = DatabricksSubmitRunOperator(
     ...
     timeout_seconds=480*60,
     databricks_retry_delay=60,
     databricks_retry_limit=3,
     notebook_task=generate_notebook_task('/production/jobs/ab-testing/bootstrapping_for_new_users'),
     new_cluster=generate_cluster(),
     dag=dag
)
...
bootstrapping_for_existing_users = DatabricksSubmitRunOperator(
    ...
    databricks_retry_delay=60,
    databricks_retry_limit=3,
    notebook_task=generate_notebook_task('/production/jobs/ab-testing/bootstrapping_for_existing_users'),
    new_cluster=generate_cluster(),
    dag=dag
)
